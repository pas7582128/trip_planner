...
$sql = "insert into addtrip (name,vehicle,from_,to_,distance,time,tripdate,currdate,cost) values('$user','bike','$from','$to','$distance','$time','$date',current_timestamp,'$cost')";
